...
- Attempting to combine CNAME with TXT records. This is not possible unless you [proxy your subdomain](https://docs.is-a.dev/domain-structure/#-proxied-optional).
